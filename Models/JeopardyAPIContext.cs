        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<FillInTheBlank>()
                .HasData(
                    ...
                    new FillInTheBlank { FillInTheBlankId = 9, Category = "General", Difficulty = "Easy", Prompt = "Determining the flow of your code based on certain conditions is called _________. (ie: If something is true, do one thing. If this same thing is false, do a different thing.)", Answer = "branching" },

                    new FillInTheBlank { FillInTheBlankId = 41, Category = "General", Difficulty = "Medium", Prompt = "_________ is the process of restructuring existing code without changing its external behavior and with the purpose of improving its readability and reducing its complexity.", Answer = "refactoring" },
                    ...
                    new FillInTheBlank { FillInTheBlankId = 53, Category = "General", Difficulty = "Hard", Prompt = "In object-oriented programming, _________ is the process of hiding and encapsulating complex code so that it's easier to use.", Answer = "abstraction" },
                    ...
                    new FillInTheBlank { FillInTheBlankId = 51, Category = "General", Difficulty = "Hard", Prompt = "Allowing a class to have total control over its own fields, preventing other classes from accessing and altering fields, and making code more maintainable are all benefits of _________.", Answer = "encapsulation" },
                    ...
                    new FillInTheBlank { FillInTheBlankId = 29, Category = "JavaScript", Difficulty = "Hard", Prompt = "_________ is a term developers use for added functionality in a programming language that makes it easier to write and read.", Answer = "syntactic sugar" },

                    new FillInTheBlank { FillInTheBlankId = 20, Category = "JavaScript", Difficulty = "Hard", Prompt = "JavaScript employs _________, which are just objects from which other objects inherit methods.", Answer = "prototypes" },
                    ...
                    new FillInTheBlank { FillInTheBlankId = 56, Category = "Testing", Difficulty = "Medium", Prompt = "We can manually add code to tell our application how to handle exceptions by using _________/_________ blocks.", Answer = "try/catch" },

                    new FillInTheBlank { FillInTheBlankId = 43, Category = "Testing", Difficulty = "Medium", Prompt = "A _________ method is used to reset data between each test, ensuring one's test results aren't affected by earlier results.", Answer = "teardown" },
                    ...
                    new FillInTheBlank { FillInTheBlankId = 36, Category = "C#", Difficulty = "Easy", Prompt = "C# is a _________-typed compiled language developed by Microsoft.", Answer = "strictly" },
